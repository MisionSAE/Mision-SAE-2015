...
uint8_t flag_hay_nuevo_dato = 0; // flag desde tarea sensores a tarea primaria
uint8_t flag_leer_sensores = 0; // flag desde tara primaria a tarea sensores
// valores de sensores
 ...
 * En esta Tarea se deben formatear los datos de los sensores y enviarlos por
 * radio a la estación terrena.
 * Utilizando la Tecla 2 se envia una señal para pedir una nueva medición,
 * mediante la variable global ΅flag_leer_sensores"
 * Luego se espera una señal de fin de medición, por la variable global
 * "flag_hay_nuevo_dato", cuando esta activa se envia por la UART USB la trama
 * con los datos de la medición.
 */
 ...
 **********************************************************************/
		...
		/*
		 * Se utiliza una tecla para enviar una flag a la
		 * tarea de sensores
		 */
		...
		if( flag_hay_nuevo_dato == 1 )
		{
			...
			DEBUG_OUT(mensaje); // Se envia por USB para Debug
